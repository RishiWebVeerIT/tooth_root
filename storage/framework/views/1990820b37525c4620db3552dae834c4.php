            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding">
                        <img src="<?php echo e(asset('user_assets/images/feature1.png')); ?>" alt="">
                        <h3>advance technology</h3>
                        <p class="pt-3">Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding mt-4 mt-md-0">
                        <img src="<?php echo e(asset('user_assets/images/feature2.png')); ?>" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding mt-4 mt-lg-0">
                        <img src="<?php echo e(asset('user_assets/images/feature3.png')); ?>" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding mt-4 mt-lg-0">
                        <img src="<?php echo e(asset('user_assets/images/feature4.png')); ?>" alt="">
            ...
            <div class="row">
                <div class="col-lg-5 align-self-center">
                    <div class="welcome-img">
                        <img src="<?php echo e(asset('user_assets/images/welcome.png')); ?>" alt="">
                    </div>
                </div>
                <div class="col-lg-7">
...
<?php echo $__env->make('Layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\One_Scan\OneScan\one_scan\resources\views/user/dashboard.blade.php ENDPATH**/ ?>