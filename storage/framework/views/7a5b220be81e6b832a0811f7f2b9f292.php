...
<head>
  ...
  <title>ToothRoot - <?php echo e($pageTitle); ?></title>
  <?php else: ?>
  <title>ToothRoot</title>
  <?php endif; ?>
...
<a href="#" class="back-to-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
  ...
  <script>
    ...
    toastr.success("<?php echo e(session::get('success')); ?>",'Success !',{timeOut: 2000});
  </script>
  <?php endif; ?>
  ...
  <script>
    ...
    toastr.error("<?php echo e(session::get('error')); ?>",'Error !',{timeOut: 2000});
  </script>
  <?php endif; ?>

</body>
</html>
<?php /**PATH C:\xampp\htdocs\ToothRoot\tooth_root\resources\views/Layouts/loginlayout.blade.php ENDPATH**/ ?>