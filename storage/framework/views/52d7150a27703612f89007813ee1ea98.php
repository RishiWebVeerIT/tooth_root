            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-start">
                ...
                <div class="tab-content" id="v-pills-tabContent">
                  ...
                  <div class="tab-pane fade <?php if($tab): ?>  <?php if($tab->description == 2): ?> show active <?php endif; ?> <?php endif; ?>" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab" style="background: #f4f6ff; padding: 20px;">
...
<?php echo $__env->make('Layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ToothRootNew\tooth_root\resources\views/admin/addHistory.blade.php ENDPATH**/ ?>